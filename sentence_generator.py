...
if __name__ == '__main__':
	...
	parser.add_argument('--save_filename', type=str, default="output.txt")
	...
	while len(sentences) < args.num_sentences:
		sentences.add(generate_random_sentence(grammar, start_symbol, False, terminals=terminals, k=args.k, ))
